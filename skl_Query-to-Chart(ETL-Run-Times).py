...
with
  w_etl_list  as
   ...
   -- union all select   5, 1154, 'RX'        from dual
   -- union all select   6,  435, 'RX-other'  from dual
    )
...
#=======================================
vLineStyles = \
  [ { "linestyle":"-", "linewidth":1, "color":"#a50000"
    , "marker":"o", "markeredgecolor":"#a50000", "markerfacecolor":"#ff87b5" }  # red
  , { "linestyle":"-", "linewidth":1, "color":"#00ba00"
    , "marker":"o", "markeredgecolor":"#00ba00", "markerfacecolor":"#00ff00" }  # green
  , { "linestyle":"-", "linewidth":1, "color":"#0000ff"
    , "marker":"o", "markeredgecolor":"#0000ff", "markerfacecolor":"#0091ff" }  # blue
  , { "linestyle":"-", "linewidth":1, "color":"#818100"
    , "marker":"o", "markeredgecolor":"#818100", "markerfacecolor":"#ffff00" }  # yellow
  ]
for vi in range(20): vLineStyles.append({}) # Extra undefined styles
